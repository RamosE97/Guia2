...
public class MainActivity extends AppCompatActivity {
    ...
    private RadioButton rbCambiar;
    private RadioButton rbNoCambiar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rbCambiar.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            @Override
            public void onCheckedChanged(CompoundButton compoundButton, boolean b) {
                if(rbCambiar.isChecked()){
